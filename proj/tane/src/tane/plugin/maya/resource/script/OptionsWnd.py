...
class OptionsWnd(object):
    ...
    def __init__(self):
        """Initialize extra data attributes"""
        ## unique window handle
        self.window = 'optionsWnd'
        ## window title
    ...
    def create(self):
        ...
        # create extra menu items and buttons
        self.commonMenu()
        self.commonButtons()
    ...
    def commonMenu(self):
        """Create extra menu items for all option boxes"""
    ...
    def commonButtons(self):
        """Create extra buttons for all option boxes"""
        self.commonBtnSize = ((self.size[0]-18)/3, 26)
        self.actionBtn = cmds.button(
            label=('%s and Close') % self.actionName,
